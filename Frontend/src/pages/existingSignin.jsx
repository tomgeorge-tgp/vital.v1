...
const Existingsignin = (props) => {
  return (
    <>
      <div className="existingsignin-container">
        <div className="existingsignin-container1">
          <div className="existingsignin-container2"></div>
          <input
            type="text"
            placeholder="Enter"
            className="existingsignin-input content input"
          />
          <span className="existingsignin-text">Exisitng user sign-in</span>
          <span className="existingsignin-text1">Name</span>
          <span className="existingsignin-text2">    </span>
          <span className="existingsignin-text3">
            Enter your name and proceed
          </span>
          <span className="existingsignin-text4">Select a mode to sign-up</span>
          <button className="existingsignin-button button">Phone</button>
          <button className="existingsignin-button1 button">
            Unique Identification No.
          </button>
          <button className="existingsignin-button2 button">Email</button>
          <button className="existingsignin-button3 button">Continue</button>
          <div className="existingsignin-html-node">
            <span
          ...
          <div className="existingsignin-html-node1">
            <span
              dangerouslySetInnerHTML={{
                __html:
          ...
          <div className="existingsignin-html-node2">
            <span
              dangerouslySetInnerHTML={{
                __html:
          ...
          <div className="existingsignin-html-node3">
            <span
              dangerouslySetInnerHTML={{
                __html:
      ...
      <style jsx>
        {`
          ...
          .existingsignin-button {
            ...
            position: absolute;
            font-size: 14px;
            box-shadow: 0px 10px 20px 0px rgba(158, 158, 158, 0.16);
            align-items: center;
            font-family: Manrope;
            line-height: 19px;
            padding-top: 19px;
          ...
          .existingsignin-html-node {
            top: 392px;
            left: 150px;
            position: absolute;
          }
          .existingsignin-html-node1 {
            top: 394px;
            left: 410px;
            position: absolute;
          }
          .existingsignin-html-node2 {
            top: 393px;
            left: 665px;
            position: absolute;
          }
          .existingsignin-html-node3 {
            top: 64px;
            left: 40px;
            position: absolute;
          }
